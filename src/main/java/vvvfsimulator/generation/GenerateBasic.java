...
public final class GenerateBasic {
    ...
    public static final class WaveForm {
        ...
        public static Struct.PhaseState[] getUVWCycle(Struct.Domain control, double initialPhase, int division, boolean precise) {
        ...
        public static Struct.PhaseState[] getUVW(Struct.Domain control, double initialPhase, double invDeltaT, int count) {
            ...
            for (int i = 0; i <= count; i++) {
                ...
                out[i] = Common.calculatePhsaseState(control, initialPhase);
            }
            return out;
        }
    }
