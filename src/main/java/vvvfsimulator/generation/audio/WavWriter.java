...
public final class WavWriter {
    ...
    public static void writeHeader(BufferedOutputStream out, int sampleRate, int bitsPerSample, int channels, int dataSize) throws IOException {
    ...
    public static BufferedOutputStream createWithHeader(String path, int sampleRate, int bitsPerSample, int channels) throws IOException {
