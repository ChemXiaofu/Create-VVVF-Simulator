...
public final class RealTime {
    ...
    public static class Parameter {
        ...
        public Struct.Domain control;
        public vvvfsimulator.data.vvvf.Struct vvvfSoundData;
        public vvvfsimulator.data.trainaudio.Struct trainSoundData;

        public Parameter(vvvfsimulator.data.vvvf.Struct vvvfSound,vvvfsimulator.data.trainaudio.Struct trainSound) {
            this.control = new Struct.Domain(trainSound.motorSpec);
    ...
    public static class VvvfSoundParameter extends Parameter {
        ...
        public VvvfSoundParameter(vvvfsimulator.data.vvvf.Struct vvvfSound,vvvfsimulator.data.trainaudio.Struct trainSound) {
    ...
    public static class TrainSoundParameter extends Parameter {
        public TrainSoundParameter(vvvfsimulator.data.vvvf.Struct vvvfSound,vvvfsimulator.data.trainaudio.Struct trainSound) {
            super(vvvfSound, trainSound);
        }
    }

    public static int realTimeFrequencyControl(Struct.Domain control, Parameter param, double dt) {
