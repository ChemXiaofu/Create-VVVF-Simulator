...
public class Struct {
    ...
    public void sortAcceleratePattern(boolean inverse) {
        acceleratePattern.sort((a, b) -> Double.compare(
                inverse ? a.controlFrequencyFrom : b.controlFrequencyFrom,
                inverse ? b.controlFrequencyFrom : a.controlFrequencyFrom
        ));
    }

    public void sortBrakingPattern(boolean inverse) {
        brakingPattern.sort((a, b) -> Double.compare(
                inverse ? a.controlFrequencyFrom : b.controlFrequencyFrom,
                inverse ? b.controlFrequencyFrom : a.controlFrequencyFrom
        ));
    }
    ...
    public boolean hasCustomPwm() {
        ...
        for (PulseControlEx control : all) {
            ...
            if (type == Pulse.PulseTypeName.CHM || type == Pulse.PulseTypeName.SHE) {
                return true;
            }
        }
        return false;
    ...
    public static class AsyncControlEx {
        ...
        public static class RandomModulationEx {
            ...
            public static class ParameterEx {
                public AsyncControl.RandomModulation.Parameter.ValueMode mode =
                        AsyncControl.RandomModulation.Parameter.ValueMode.Const;
        ...
        public static class CarrierFrequencyEx {
            public AsyncControl.CarrierFrequency.ValueMode mode = AsyncControl.CarrierFrequency.ValueMode.Const;
            ...
            public static class VibratoValueEx {
                ...
                public ParameterEx interval = new ParameterEx();
                public AsyncControl.CarrierFrequency.VibratoValue.BaseWaveType baseWave =
                        AsyncControl.CarrierFrequency.VibratoValue.BaseWaveType.Triangle;
            ...
            public static class TableValue {
                ...
                public TableValue copy() {
                    ...
                    for (Parameter parameter : table) {
                        copy.table.add(parameter.copy());
                    }
                    return copy;
                }
    ...
    public static class PulseDataValueEx {
        public PulseDataValue.PulseDataValueMode mode = PulseDataValue.PulseDataValueMode.Const;
        public double constant = -1;
        public FunctionValue movingValue = new FunctionValue();
    ...
    public static void ensurePulseDataDefaults(PulseControlEx pattern) {
        ...
        if (pulse.pulseData == null) {
            pulse.pulseData = new HashMap<>();
        }
